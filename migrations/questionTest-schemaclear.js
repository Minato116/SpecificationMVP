module.exports = {
  async up(db, client) {
    await db.createCollection("questions1", {
      validator: {
        $jsonSchema: {
          bsonType: "object",
    ...
    console.log("✅ Migration UP: Created 'questions1' collection with required fields and schema.");
  },

  async down(db, client) {
    await db.collection("questions1").drop();
    console.log("⏪ Migration DOWN: Dropped 'questions1' collection.");
  }
};
